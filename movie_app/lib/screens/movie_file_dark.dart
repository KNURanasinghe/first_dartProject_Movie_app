...
import 'detailed_dark.dart';

// ignore: must_be_immutable
class Movie_ScreenDark extends StatelessWidget {
  Movie_ScreenDark({super.key});
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: SizedBox(
                ...
                child: Card(
                  elevation: 5,
                  color: const Color.fromARGB(66, 63, 61, 61),
                  child: Row(
                    children: [
                      Container(
                        height: 150,
